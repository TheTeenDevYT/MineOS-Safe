...
local r = _G.require
_G.require = function(l)
	local m, p = r(l)
	if p then
		local perm = false
		require("GUI").alert("Script/App Wants permision to Protected Lib: "  .. l .. " (press Alt to grant)")
		local go = true
		local count = 0
		repeat
